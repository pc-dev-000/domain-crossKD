...
class InferenceGANOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--data_in", help="path to transform", required=False)
        parser.add_argument("--data_out", help="path to save image", required=False)
        parser.add_argument("--img_in", help="image to transform", required=False)
        parser.add_argument("--img_out", help="transformed image", required=False)
        parser.add_argument(
